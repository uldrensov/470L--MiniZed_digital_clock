...
proc create_root_design { parentCell } {
  ...
  set ARDUINO_IO12_0 [ create_bd_port -dir I ARDUINO_IO12_0 ]
  ...
  set ARDUINO_IO7_0 [ create_bd_port -dir O ARDUINO_IO7_0 ]
  set ARDUINO_IO8_0 [ create_bd_port -dir O ARDUINO_IO8_0 ]
  set ARDUINO_IO9_0 [ create_bd_port -dir O ARDUINO_IO9_0 ]
  set PL_LED_G_0 [ create_bd_port -dir O PL_LED_G_0 ]
  set PL_LED_R_0 [ create_bd_port -dir O PL_LED_R_0 ]

  # Create instance: DIGITAL_CLOCK_0, and set properties
  set block_name DIGITAL_CLOCK
  set block_cell_name DIGITAL_CLOCK_0
  if { [catch {set DIGITAL_CLOCK_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $DIGITAL_CLOCK_0 eq "" } {
  ...
  connect_bd_net -net ARDUINO_A0_0_1 [get_bd_ports ARDUINO_A0_0] [get_bd_pins DIGITAL_CLOCK_0/ARDUINO_A0]
  connect_bd_net -net ARDUINO_A1_0_1 [get_bd_ports ARDUINO_A1_0] [get_bd_pins DIGITAL_CLOCK_0/ARDUINO_A1]
  connect_bd_net -net ARDUINO_A2_0_1 [get_bd_ports ARDUINO_A2_0] [get_bd_pins DIGITAL_CLOCK_0/ARDUINO_A2]
  connect_bd_net -net ARDUINO_IO12_0_1 [get_bd_ports ARDUINO_IO12_0] [get_bd_pins DIGITAL_CLOCK_0/ARDUINO_IO12]
  connect_bd_net -net DIGITAL_CLOCK_0_ARDUINO_IO0 [get_bd_ports ARDUINO_IO0_0] [get_bd_pins DIGITAL_CLOCK_0/ARDUINO_IO0]
  connect_bd_net -net DIGITAL_CLOCK_0_ARDUINO_IO1 [get_bd_ports ARDUINO_IO1_0] [get_bd_pins DIGITAL_CLOCK_0/ARDUINO_IO1]
  connect_bd_net -net DIGITAL_CLOCK_0_ARDUINO_IO2 [get_bd_ports ARDUINO_IO2_0] [get_bd_pins DIGITAL_CLOCK_0/ARDUINO_IO2]
  connect_bd_net -net DIGITAL_CLOCK_0_ARDUINO_IO3 [get_bd_ports ARDUINO_IO3_0] [get_bd_pins DIGITAL_CLOCK_0/ARDUINO_IO3]
  connect_bd_net -net DIGITAL_CLOCK_0_ARDUINO_IO4 [get_bd_ports ARDUINO_IO4_0] [get_bd_pins DIGITAL_CLOCK_0/ARDUINO_IO4]
  connect_bd_net -net DIGITAL_CLOCK_0_ARDUINO_IO5 [get_bd_ports ARDUINO_IO5_0] [get_bd_pins DIGITAL_CLOCK_0/ARDUINO_IO5]
  connect_bd_net -net DIGITAL_CLOCK_0_ARDUINO_IO6 [get_bd_ports ARDUINO_IO6_0] [get_bd_pins DIGITAL_CLOCK_0/ARDUINO_IO6]
  connect_bd_net -net DIGITAL_CLOCK_0_ARDUINO_IO7 [get_bd_ports ARDUINO_IO7_0] [get_bd_pins DIGITAL_CLOCK_0/ARDUINO_IO7]
  connect_bd_net -net DIGITAL_CLOCK_0_ARDUINO_IO8 [get_bd_ports ARDUINO_IO8_0] [get_bd_pins DIGITAL_CLOCK_0/ARDUINO_IO8]
  connect_bd_net -net DIGITAL_CLOCK_0_ARDUINO_IO9 [get_bd_ports ARDUINO_IO9_0] [get_bd_pins DIGITAL_CLOCK_0/ARDUINO_IO9]
  connect_bd_net -net DIGITAL_CLOCK_0_ARDUINO_IO10 [get_bd_ports ARDUINO_IO10_0] [get_bd_pins DIGITAL_CLOCK_0/ARDUINO_IO10]
  connect_bd_net -net DIGITAL_CLOCK_0_ARDUINO_IO11 [get_bd_ports ARDUINO_IO11_0] [get_bd_pins DIGITAL_CLOCK_0/ARDUINO_IO11]
  connect_bd_net -net DIGITAL_CLOCK_0_PL_LED_G [get_bd_ports PL_LED_G_0] [get_bd_pins DIGITAL_CLOCK_0/PL_LED_G]
  connect_bd_net -net DIGITAL_CLOCK_0_PL_LED_R [get_bd_ports PL_LED_R_0] [get_bd_pins DIGITAL_CLOCK_0/PL_LED_R]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins DIGITAL_CLOCK_0/CLK] [get_bd_pins processing_system7_0/FCLK_CLK0]
